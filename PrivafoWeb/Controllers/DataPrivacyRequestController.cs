...
{
    public class DataPrivacyRequestController : Controller
    {
        private readonly IUnitOfWork _uow;
        private readonly IEmailSender _emailSender;

        public DataPrivacyRequestController(IUnitOfWork uow, IEmailSender emailSender)
        {
            _uow = uow;
        ...
        public IActionResult Insert(RiskRegisterVM obj)
        {
