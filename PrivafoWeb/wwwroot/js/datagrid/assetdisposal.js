...
function loadDataTable(jsonFilter) {
    ...
    dataTable = $('#tblData').DataTable({
        ...
        "ajax": {
            "url": "/assetdisposal/GetAll?jsonFilter=" + jsonFilter
        },
        "columns": [
            { "data": "astDisposalName", "width": "15%" },
                ...
                "render": function (data) {
                    return `
                            <div class="d-flex order-actions">
								<a onclick="showInPopup('/assetdisposal/Upsert/${data}', 'Update Data Asset Disposal')" class="ms-3 cursor-pointer"><i class='bx bxs-edit'></i></a>
								<a onClick="Delete('/assetdisposal/Delete/${data}')" class="ms-3 cursor-pointer"><i class='bx bxs-trash'></i></a>
							</div>
                        `
                },
                "width": "10%"
