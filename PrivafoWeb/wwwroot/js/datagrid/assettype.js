...
function loadDataTable(jsonFilter) {
    ...
    dataTable = $('#tblData').DataTable({
        ...
        "ajax": {
            "url": "/assettype/GetAll?jsonFilter=" + jsonFilter
        },
        "columns": [
            { "data": "astTypeName", "width": "15%" },
                ...
                "render": function (data) {
                    return `
                            <div class="d-flex order-actions">
								<a onclick="showInPopup('/assettype/Upsert/${data}', 'Update Data Asset Type')" class="ms-3 cursor-pointer"><i class='bx bxs-edit'></i></a>
								<a onClick="Delete('/assettype/Delete/${data}')" class="ms-3 cursor-pointer"><i class='bx bxs-trash'></i></a>
							</div>
                        `
                },
                "width": "10%"
