...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        ...
        "ajax": {
            "url": "/PrivacyReqType/GetAll"
        },
        "columns": [
            { "data": "requestTypeName", "width": "15%" },
                ...
                "render": function (data) {
                    return `
                            <div class="d-flex order-actions">
								<a onclick="showInPopup('/PrivacyReqType/Upsert/${data}', 'Update Privacy Request Type')" class="ms-3 cursor-pointer"><i class='bx bxs-edit'></i></a>
								<a onClick="Delete('/PrivacyReqType/Delete/${data}')" class="ms-3 cursor-pointer"><i class='bx bxs-trash'></i></a>
							</div>
                        `
                },
                "width": "10%"
