...
function loadDataTable(jsonFilter) {
    ...
    dataTable = $('#tblData').DataTable({
        ...
        "ajax": {
            "url": "/venproductctg/GetAll?jsonFilter=" + jsonFilter
        },
        "columns": [
            { "data": "venProdCtgName", "width": "15%" },
                ...
                "render": function (data) {
                    return `
                            <div class="d-flex order-actions">
								<a onclick="showInPopup('/VenProductCtg/Upsert/${data}', 'Update Category Vendor')" class="ms-3 cursor-pointer"><i class='bx bxs-edit'></i></a>
								<a onClick="Delete('/VenProductCtg/Delete/${data}')" class="ms-3 cursor-pointer"><i class='bx bxs-trash'></i></a>
							</div>
                        `
                },
                "width": "10%"
